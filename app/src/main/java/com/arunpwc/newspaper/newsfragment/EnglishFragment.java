...
public class EnglishFragment extends Fragment {
    ...
    private List<NewsObject> getAllItemList() {
        ...
        allItems.add(new NewsObject(getResources().getString(R.string.ndtv_en_url), getResources().getString(R.string.ndtv_en_url), R.drawable.ndtv247_icon, ContextCompat.getColor(getActivity(), R.color.tile6)));
        allItems.add(new NewsObject(getResources().getString(R.string.ibncnn_en), getResources().getString(R.string.ibncnn_en_url), R.drawable.cnn_ibn_icon, ContextCompat.getColor(getActivity(), R.color.tile3)));
        allItems.add(new NewsObject(getResources().getString(R.string.hindustan_en), getResources().getString(R.string.hindustan_en_url), R.drawable.hindustan_times_icon, ContextCompat.getColor(getActivity(), R.color.tile4)));
        allItems.add(new NewsObject(getResources().getString(R.string.economicTimes_en), getResources().getString(R.string.economicTimes_en_url), R.drawable.ecnomic_times_icon, ContextCompat.getColor(getActivity(), R.color.tile1)));
        allItems.add(new NewsObject(getResources().getString(R.string.first_post_en), getResources().getString(R.string.first_post_en_url), R.drawable.firstpost_icon, ContextCompat.getColor(getActivity(), R.color.tile2)));
